...
1. Clone the NADIR Core source code:

        git clone https://github.com/nadir-project/nadir
        cd nadir
...
NADIR Core is now available at `./src/nadird`

Before running, you may create an empty configuration file:

    mkdir -p "/Users/${USER}/Library/Application Support/NADIR"

    touch "/Users/${USER}/Library/Application Support/NADIR/nadir.conf"

    chmod 600 "/Users/${USER}/Library/Application Support/NADIR/nadir.conf"

The first time you run nadird, it will start downloading the blockchain. This process could take many hours, or even days on slower than average systems.

You can monitor the download process by looking at the debug.log file:

    tail -f $HOME/Library/Application\ Support/NADIR/debug.log

Other commands:
-------

    ./src/nadird -daemon # Starts the nadir daemon.
    ./src/nadir-cli --help # Outputs a list of command-line options.
    ./src/nadir-cli help # Outputs a list of RPC commands when the daemon is running.
