...
The NADIR Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/nadir-project/nadir/blob/master/doc/translation_process.md)
...
The following applies to code changes to the NADIR Core project, and is not to be
confused with overall NADIR Network Protocol consensus changes.

Whether a pull request is merged into NADIR Core rests with the project merge
...
Patches that change NADIR consensus rules are considerably more involved than
...
Where a patchset proposes to change the NADIR consensus, it must have been
...
The project leader is the release manager for each NADIR Core release.
