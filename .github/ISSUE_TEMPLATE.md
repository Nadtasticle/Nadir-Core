...
This issue tracker is only for technical issues related to NADIR Core.
General NADIR questions and/or support requests and are best directed to the [NADIR Discord](https://discord.nadir.org).
...
### What version of NADIR Core are you using?
