...
RESOURCES += src/qt/nadir.qrc src/qt/nadir_locale.qrc

TRANSLATIONS += src/qt/locale/nadir_bg.ts \
                src/qt/locale/nadir_de.ts \
                src/qt/locale/nadir_en.ts \
                src/qt/locale/nadir_es.ts \
                src/qt/locale/nadir_fi.ts \
                src/qt/locale/nadir_fr.ts \
                src/qt/locale/nadir_it.ts \
                src/qt/locale/nadir_ja.ts \
                src/qt/locale/nadir_pl.ts \
                src/qt/locale/nadir_pt.ts \
                src/qt/locale/nadir_ru.ts \
                src/qt/locale/nadir_sk.ts \
                src/qt/locale/nadir_sv.ts \
                src/qt/locale/nadir_vi.ts \
                src/qt/locale/nadir_zh_CN.ts \
                src/qt/locale/nadir_zh_TW.ts
