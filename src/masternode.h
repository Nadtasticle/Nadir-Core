...
#define MASTERNODE_MIN_CONFIRMATIONS 19
...
//
// The Masternode Class. For managing the Obfuscation process. It contains the input of the 10000 NAD, signature to prove
