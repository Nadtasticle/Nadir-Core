...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* NADIR features */
        {"nadir", "listmasternodes", &listmasternodes, true, true, false},
        {"nadir", "getmasternodecount", &getmasternodecount, true, true, false},
        {"nadir", "masternodeconnect", &masternodeconnect, true, true, false},
        {"nadir", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"nadir", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"nadir", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"nadir", "masternodecurrent", &masternodecurrent, true, true, false},
        {"nadir", "masternodedebug", &masternodedebug, true, true, false},
        {"nadir", "startmasternode", &startmasternode, true, true, false},
        {"nadir", "createmasternodekey", &createmasternodekey, true, true, false},
        {"nadir", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"nadir", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"nadir", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"nadir", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"nadir", "getmasternodescores", &getmasternodescores, true, true, false},
        {"nadir", "preparebudget", &preparebudget, true, true, false},
        {"nadir", "submitbudget", &submitbudget, true, true, false},
        {"nadir", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"nadir", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"nadir", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"nadir", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"nadir", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"nadir", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"nadir", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"nadir", "checkbudgets", &checkbudgets, true, true, false},
        {"nadir", "mnsync", &mnsync, true, true, false},
        {"nadir", "spork", &spork, true, true, false},
        {"nadir", "getpoolinfo", &getpoolinfo, true, true, false},
        ...
        {"zerocoin", "getznadseed", &getznadseed, false, false, true},
        {"zerocoin", "setznadseed", &setznadseed, false, false, true},
        {"zerocoin", "generatemintlist", &generatemintlist, false, false, true},
        {"zerocoin", "searchdznad", &searchdznad, false, false, true},
        {"zerocoin", "dznadstate", &dznadstate, false, false, true},
...
{
    return "> nadir-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:22339/\n";
}
