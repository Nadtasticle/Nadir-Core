...
extern UniValue DoZnadSpend(const CAmount nAmount, bool fMintChange, bool fMinimizeChange, vector<CZerocoinMint>& vMintsSelected, std::string address_str, bool isPublicSpend = true);
...
extern UniValue setznadseed(const UniValue& params, bool fHelp);
extern UniValue getznadseed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
extern UniValue searchdznad(const UniValue& params, bool fHelp);
extern UniValue dznadstate(const UniValue& params, bool fHelp);
