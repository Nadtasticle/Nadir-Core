                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzNADPathCustom = GetArg("-znadbackuppath", "");
    ...
    if(!strzNADPathCustom.empty()) {
        ui->wallet_customznadbackuppath->setText(QString::fromStdString(strzNADPathCustom));
        ui->wallet_customznadbackuppath_label->setVisible(true);
        ui->wallet_customznadbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzNADPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the NADIR RPC console.") + "<br>" +
