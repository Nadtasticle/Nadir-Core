...
/** Utility functions used by the NADIR Qt UI.
 */
namespace GUIUtil
{
...
// Render NADIR addresses in monospace font
...
// Parse "nadir:" URI into recipient object, return true on successful parsing
