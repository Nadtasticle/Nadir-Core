...
void OptionsModel::Init()
{
    ...
    if (!settings.contains("nDisplayUnit"))
        settings.setValue("nDisplayUnit", BitcoinUnits::NAD);
...
// Wallet
    ...
    if (settings.contains("nAnonymizeNADIRAmount"))
        SoftSetArg("-anonymizenadiramount", settings.value("nAnonymizeNADIRAmount").toString().toStdString());
...
void OptionsModel::Reset()
{
    ...
    settings.clear();
    resetSettings = true; // Needed in nadir.cpp during shotdown to also remove the window positions
