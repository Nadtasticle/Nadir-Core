...
/* NADIR GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "NADIR"
#define QAPP_ORG_DOMAIN "nadir.org"
#define QAPP_APP_NAME_DEFAULT "NADIR-Qt"
#define QAPP_APP_NAME_TESTNET "NADIR-Qt-testnet"
