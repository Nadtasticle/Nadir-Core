...
#ifndef NADIR_ZNADTRACKER_H
#define NADIR_ZNADTRACKER_H
...
public:
    CzNADTracker(std::string strWalletFile);
    ~CzNADTracker();
    void Add(const CDeterministicMint& dMint, bool isNew = false, bool isArchived = false, CzNADWallet* zNADWallet = NULL);
