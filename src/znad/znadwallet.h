...
#ifndef NADIR_ZNADWALLET_H
#define NADIR_ZNADWALLET_H
...
public:
    CzNADWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZNAD(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZNAD(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);
