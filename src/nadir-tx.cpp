...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("NADIR Core nadir-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  nadir-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded nadir transaction") + "\n" +
                               "  nadir-tx [options] -create [commands]   " + _("Create hex-encoded nadir transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded nadir transaction
