...
from fake_stake.base_test import NADIR_FakeStakeTest

class zNADwrappedSerialsTest(NADIR_FakeStakeTest):
    ...
    def run_test(self):
        ...
        # 2) Mint zerocoins
        self.log.info("Minting %d-denom zNADs..." % DENOM_TO_USE)
